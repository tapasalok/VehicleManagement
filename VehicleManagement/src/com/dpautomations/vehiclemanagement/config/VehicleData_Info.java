...
public interface VehicleData_Info {
	    ...
	    public static final String CREATE_TABLE_VEHICLE_REGISTRATION = "CREATE TABLE "+ TABLE_VEHICLE_REGISTER + "(" + KEY_VEHICLE_REGISTRATION_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_VEHICLE_NO + " TEXT," + KEY_PLANT + " TEXT," + KEY_OUT_DATE_TIME + " TEXT," + KEY_TRANSPORTERNAME + " TEXT," + KEY_VEHICLE_STATE + " TEXT" +")";
